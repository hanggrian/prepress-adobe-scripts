  ...
  aboutPanel =
      new AboutPanel(main, clientDate).apply(function(panel) {
        ...
        panel.preferencesClearButton.addClickListener(function() {
          ...
          preferences2.resolve('artboards/reorder').run(function(it) {
            it.remove('order')
          })
          ...
          preferences2.resolve('links').run(function(subconfigs) {
          ...
          preferences2.resolve('objects').run(function(subconfigs) {
          ...
          preferences2.resolve('select').run(function(subconfigs) {
          ...
          preferences2.resolve('types/numerize').run(function(it) {
            it.remove('start')
            it.remove('digit')
