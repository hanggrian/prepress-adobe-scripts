...
if (pickedFiles !== null && Collections.isNotEmpty(pickedFiles)) {
  ...
  dialog.setDefaultButton(
      ...
      function() {
        ...
        var artboardLength = pageRange.getLength() / 8;
        ...
        var rotatedPageWidth =
            !nupGroup.isFolding() && nupGroup.isRotate() ? pageHeight : pageWidth;
        ...
        } else if (parseInt(documentPanel.getWidth()) < parseInt(rotatedPageWidth * 4) ||
        ...
        Collections.forEach(
            ...
            function(artboard) {
              ...
              var x1 =
                  artboardRect.getLeft() + (artboardRect.getWidth() - rotatedPageWidth * 4) / 2;
              var x2 = x1 + rotatedPageWidth;
              var x3 = x2 + rotatedPageWidth;
              var x4 = x3 + rotatedPageWidth;
              var y1 =
                  artboardRect.getTop() - (artboardRect.getHeight() - rotatedPageHeight * 2) / 2;
