    ...
    nextDialog.hgroup(function(main) {
      ...
      main.vgroup(function(rootPane) {
        ...
        rootPane.hgroup(function(group) {
          ...
          sectionAddEdit =
              group.editText(SIZE_DIVISION_EDIT).apply(function(it) {
                it.validateDigits()
                it.activate()
              })
        })
        rootPane.hgroup(function(group) {
          sectionAddButton =
              group.iconButton(SIZE_DIVISION_BUTTON, 'btn_add', STYLE_TOOLBUTTON)
                  .apply(function(it) {
          ...
          sectionRemoveButton =
              group.iconButton(SIZE_DIVISION_BUTTON, 'btn_remove', STYLE_TOOLBUTTON)
                  .apply(function(it) {
                    it.addClickListener(function() {
      ...
      main.sgroup()
      sectionList =
          main.listBox(SIZE_DIVISION_LIST, [], {multiselect: true}).apply(function(it) {
