 ...
 * @return {Group}
 */
Object.prototype.addSpreaderGroup = function() {
    var spreader = this.addVGroup()

    spreader.copies = spreader.addHGroup()
    spreader.copies.addText(spreaderTextBounds, 'Copies:', 'right')
    spreader.horizontalEdit = spreader.copies.addEditText(spreaderEditBounds2)
    spreader.horizontalEdit.validateDigits()
    spreader.copies.addText(undefined, '×')
    spreader.verticalEdit = spreader.copies.addEditText(spreaderEditBounds2)
    spreader.verticalEdit.validateDigits()
    ...
    spreader.gapHorizontalEdit = spreader.gapHorizontal.addEditText(spreaderEditBounds, '0 mm')
    spreader.gapHorizontalEdit.validateUnits()
    ...
    spreader.gapVerticalEdit = spreader.gapVertical.addEditText(spreaderEditBounds, '0 mm')
    spreader.gapVerticalEdit.validateUnits()
 ...
 */
Object.prototype.spread = function(horizontalRunnable, verticalRunnable) {
