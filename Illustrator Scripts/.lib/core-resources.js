...
R.string.from_artboard = { en: "From Artboard", id: "Dari Papan Seni" }
...
R.string.impose_section_sewn = { en: "Impose Section-Sewn", id: "Susun Jahit Benang" }
...
R.string.preset_type = { en: "Preset Type", id: "Jenis Preset" }
...
R.string.tip_expandreflected_locations = { en: "Determine where reflections are created.", id: "Tentukan di mana refleksi dibuat." }
R.string.tip_expandreflected_useguides = { en: "Leave rectangle guide where main object was.", id: "Tinggalkan panduan persegi panjang di mana objek utama berada." }
R.string.tip_impose_rtl = { en: "Useful for Arabic layout.", id: "Berguna untuk susunan bahasa Arab." }
R.string.tip_impose_sectionsewn_add = { en: "Add a section by inserting a new item into list of sections.", id: "Tambahkan bagian dengan memasukkan barang baru ke dalam daftar bagian." }
R.string.tip_impose_sectionsewn_remove = { en: "Remove a section by selecting an existing item in the list.", id: "Hapus bagian dengan memilih item yang ada dalam daftar." }
