...
function NUpOptionsGroup(parent, showFolding, showRotate, showDuplex, showStack) {
  ...
  if (showFolding) {
    self.foldingCheck =
        self
            .checkBox(undefined, R.string.folding_booklet)
            .apply(function(it) {
  ...
  if (showRotate) {
    self.rotateCheck =
        self
            .checkBox(undefined, R.string.rotate_pages)
            .apply(function(it) {
  ...
  if (showDuplex) {
    self.duplexCheck =
        self
            .checkBox(undefined, R.string.duplex_printing)
            .apply(function(it) {
  ...
  if (showStack) {
    self.stackCheck =
        self
            .checkBox(undefined, R.string.cut_stack)
            .apply(function(it) {
