...
dialog.vgroup(function(main) {
  main.vgroup(function(topPane) {
    ...
    topPane.hgroup(function(group) {
      ...
      widthCheck = group.checkBox(SIZE_INPUT_CHECK).apply(function(it) {
        it.select()
    ...
    topPane.hgroup(function(group) {
      ...
      heightCheck = group.checkBox(SIZE_INPUT_CHECK).apply(function(it) {
        it.select()
  ...
  main.hgroup(function(rootPane) {
    ...
    rootPane.vpanel(R.string.change, function(panel) {
      ...
      changePositionsCheck = panel.checkBox(undefined, R.string.positions).apply(function(it) {
