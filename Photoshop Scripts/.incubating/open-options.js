...
function OpenDocumentPanel(parent) {
  ...
  self.resolutionEdit;
  self.unitsList;
  self.backgrounTransparentRadio;
  self.backgrounWhiteRadio;
  ...
  self.hgroup(function(group) {
    ...
    self.backgrounTransparentRadio = group.radioButton(undefined, 'Transparent').apply(SELECTED);
