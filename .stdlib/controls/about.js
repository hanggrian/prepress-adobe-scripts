      ...
      self.vtab(
          ...
          function(tab) {
            ...
            tab.hgroup(function(group) {
              ...
              self.preferencesThemeList =
                  group
                      .dropDownList(undefined, Theme.list())
                      .apply(function(it) {
              ...
              self.preferencesLanguageList =
                  group
                      .dropDownList(undefined, Language.list())
                      .apply(function(it) {
            ...
            tab.hgroup(function(group) {
              ...
              self.preferencesActivateControl =
                  group
                      .checkBox(undefined, R.string.activate_control_on_start)
                      .apply(function(it) {
            ...
            self.preferencesClearButton =
                tab
                    .button(undefined, R.string.clear_preferences)
                    .apply(function(it) {
  ...
  self.updatesTab =
      self.vtab(
          ...
          function(tab) {
            ...
            tab.alignChildren = 'left';
            self.updatesStatusText =
                tab.staticText([400, 21], R.string.message_aboutscripts_updates);
            tab.hgroup(function(group) {
              group
                  .button(undefined, R.string.check_updates)
                  .apply(function(it) {
                    it.maximumSize.height = 20;
              ...
              self.updatesDownloadButton =
                  group
                      .button(undefined, R.string.download)
                      .apply(function(it) {
                        it.maximumSize.height = 20;
                        it.enabled = false;
                        it.addClickListener(function() {
