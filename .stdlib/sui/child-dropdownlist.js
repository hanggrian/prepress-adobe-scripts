 ...
 * @return {boolean}
 */
DropDownList.prototype.hasSelection =
    function() {
 ...
 */
DropDownList.prototype.selectText =
    function(text) {
      this.selection =
          Collections.indexOf(
              Collections.map(
 ...
 */
DropDownList.prototype.addChangeListener =
    function(listener) {
 ...
 * @return {!DropDownList}
 */
Panel.prototype.dropDownList =
    function(size, items, properties) {
      return Internals.addDropDownList(this, size, items, properties);
    };

Internals.addDropDownList =
